...
public class Cube6x6Component extends CubeComponent{
    public Cube6x6Component(Cube cube){
        super(cube);
    }
    ...
    protected void drawUp(Graphics2D g2, int x, int y, int size, int offset) {
        ...
        for(int i=0;i<this.cube.up.length;i++){
            ...
            this.stickerDrawer.drawUpSticker(g2, this.cube.up[5][i], x0, y0, size);
            this.stickerDrawer.drawUpSticker(g2, this.cube.up[4][i], x1, y1, size);
            this.stickerDrawer.drawUpSticker(g2, this.cube.up[3][i], x2, y2, size);
            this.stickerDrawer.drawUpSticker(g2, this.cube.up[2][i], x3, y3, size);
            this.stickerDrawer.drawUpSticker(g2, this.cube.up[1][i], x4, y4, size);
            this.stickerDrawer.drawUpSticker(g2, this.cube.up[0][i], x5, y5, size);
        }
    }
    ...
    public void paintComponent(Graphics g){
        ...
        int x = 250, y=250, size=40, offset=2;
